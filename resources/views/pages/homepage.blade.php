...
<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer pt-0 pl-0">
            <div class="col">
              <div class="row">
                <div class="col-6">
                  <button type="button" form="login-form" class="btn btn-lg btn-primary" onclick="location.href='dashboard.html';">Sign In</button>
                </div>
              ...
              <div class="register-callout mt-3 pt-1">
                Need an account? <button class="btn pl-1 pt-0" data-dismiss="modal" aria-label="Close"
                  data-toggle="modal" data-target="#registerModal">Sign up now!</button>
              </div>
    ...
    <div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel"
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title font-weight-bold" id="ModalLabel">Create a workpad account</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body pb-0">
            <form id="register-form" class="p-0 justify-content-center">

              <div class="form-group input-group-lg py-1">
                <input class="border rounded form-control" placeholder="Name" type="email">
              </div>
              <div class="form-group input-group-lg py-1">
                <input class="border rounded form-control" placeholder="Email" type="email">
              </div>
          ...
          <div class="modal-footer pt-0 pl-0">
            <div class="col">
              <div class="row">
                <div class="col-6">
                  <button type="button" form="register-form" class="btn btn-lg btn-primary" onclick="location.href='dashboard.html';">Create account</button>
                </div>

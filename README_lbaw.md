...
You may install the required software with:
    ...
    sudo apt-get install git composer php7.2 php7.2-mbstring php7.2-xml php7.2-pgsql php7.2-bcmath
...
To start the development server, from the project's root run:
    ...
    # if you have telescope, do the migrations
    php artisan migrate
...
You can test the image locally by running:
    ...
    docker run -it -p 8000:80 -e DB_DATABASE="postgres" -e DB_USERNAME="postgres" -e DB_PASSWORD='pg!lol!2019' <DOCKER_USERNAME>/lbaw18GG
